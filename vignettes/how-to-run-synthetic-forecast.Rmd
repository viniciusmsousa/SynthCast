...
The easiest way to plot the projection is to use the `ggplot2` package with just a few line of code

```{r plot projection, fig.width=8}
library(ggplot2)
proj<- synthetic_forecast$output_projecao

proj %>% 
  ggplot(aes(x=time_period,y=projected_serie_value, color=is_projected))+
  geom_line()+
